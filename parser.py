...
class PasParser(Parser):
	...
	@_("declarations var_declaration ';'")
	def declarations(self, p):
		pass

	@_("declarations const_declaration ';'")
	def declarations(self, p):
		pass
	...
	@_("VAR identifier_list ':' type ';'")
	def var_declaration(self, p):
		pass

	@_("VAR identifier_list ':' type ASSIGN expression ';'")
	def var_declaration(self, p):
		pass
	...
	@_("ARRAY '[' num '.' '.' num ']' OF standard_type")
	def type(self, p):
		pass
	...
	@_("subprogram_declarations subprogram_declaration ';'")
	...
	@_("identifier_list ':' type")
	def parameter_list(self, p):
		pass

	@_("parameter_list ';' identifier_list ':' type")
	def parameter_list(self, p):
		pass
	...
	@_("term mulop factor")
	def term(self, p):
		return BinOp(p.mulop, p.term, p.factor)
	...
	@_("STRING")
	def constant(self, p):
		return CharLiteral(p.STRING)

	@_("BOOL")
	def constant(self, p):
		return BoolLiteral(p.BOOL)
